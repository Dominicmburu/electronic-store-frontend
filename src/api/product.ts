const productAPI = {
    ...
    ALL_PRODUCTS: (page: number, limit: number, sortParam: string | undefined, p0: string | undefined, p1: string | undefined) => `http://127.0.0.1:5000/api/products?page=${page}&limit=${limit}`,
